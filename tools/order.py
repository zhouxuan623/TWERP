...
def login():
    dr.get("https://sso.shoplineapp.com/users/sign_in")
    dr.find_element_by_xpath("//input[@id='staff_email']").send_keys("yswang.cn@gmail.com")
...
def order():
    ...
    if b==2:
        ...
        dr.find_element_by_xpath("//span[@color='INK_600'][text()='SHOPLINE.bakery']").click()
